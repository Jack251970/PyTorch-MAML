...
def parse_launch_parameters():
    ...
    parser.add_argument('--root_path', type=str, default='./.materials/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='wind/Zone1/Zone1.csv', help='data file')
    ...
    parser.add_argument('--pin_memory', type=bool, default=False, help='pin memory of data loader')
