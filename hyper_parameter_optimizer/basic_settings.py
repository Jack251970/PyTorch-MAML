...
def parse_launch_parameters(_script_mode):
    ...
    parser.add_argument('--train_checkpoint_path', type=str, default=None,
                        help='save model parameters to checkpoint before training during training')
    parser.add_argument('--test_checkpoint_path', type=str, default=None,
                        help='load model parameters from checkpoint before testing during testing')
...
def build_config_dict(_args):
    return {
        ...
        'train_checkpoint_path': _args.train_checkpoint_path,
...
def set_args(_args, _config):
    ...
    _args.train_checkpoint_path = _config['train_checkpoint_path']
...
def prepare_config(_params, _script_mode=False):
    ...
    if _script_mode is True or _params is None:
        ...
        if 'train_checkpoint_path' in _params:
            _args.train_checkpoint_path = _params['train_checkpoint_path']
...
def get_fieldnames(mode='all'):
    ...
    all_fieldnames = ['model', 'data_path', 'custom_params', 'mse', 'mae', 'acc', 'smape', 'f_score', 'crps', 'mre',
                      ...
                      'num_spline', 'sample_times', 'run_time', 'train_checkpoint_path', 'test_checkpoint_path']
